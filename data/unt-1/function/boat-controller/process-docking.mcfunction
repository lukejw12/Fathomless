...
execute if score #distance unt-1.temp matches ..2500 if entity @e[type=armor_stand,tag=unt-1.dock,limit=1,sort=nearest,distance=..2] as @a[distance=..5] run function unt-1:market/show_dock_dialog