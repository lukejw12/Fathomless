...
execute if items entity @s container.3 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.5 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:5}
execute if items entity @s container.4 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.6 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:6}
execute if items entity @s container.5 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.7 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:7}
execute if items entity @s container.6 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.8 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:8}

execute if items entity @s container.9 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.11 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:11}
execute if items entity @s container.10 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.12 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:12}
execute if items entity @s container.11 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.13 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:13}
execute if items entity @s container.12 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.14 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:14}
execute if items entity @s container.13 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.15 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:15}
execute if items entity @s container.14 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.16 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:16}
execute if items entity @s container.15 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.17 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:17}

execute if items entity @s container.18 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.20 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:20}
execute if items entity @s container.19 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.21 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:21}
execute if items entity @s container.20 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.22 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:22}
execute if items entity @s container.21 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.23 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:23}
execute if items entity @s container.22 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.24 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:24}
execute if items entity @s container.23 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.25 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:25}
execute if items entity @s container.24 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.26 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:26}

execute if items entity @s container.27 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.29 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:29}
execute if items entity @s container.28 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.30 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:30}
execute if items entity @s container.29 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.31 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:31}
execute if items entity @s container.30 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.32 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:32}
execute if items entity @s container.31 *[custom_data~{unt-1.blocks_diagonal:1b}] if items entity @s container.33 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] run return run function unt-1:inventory/return-item {slot:33}
...
execute if items entity @s container.5 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.3 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:5}
execute if items entity @s container.6 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.4 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:6}
execute if items entity @s container.7 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.5 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:7}
execute if items entity @s container.8 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.6 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:8}

execute if items entity @s container.11 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.9 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:11}
execute if items entity @s container.12 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.10 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:12}
execute if items entity @s container.13 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.11 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:13}
execute if items entity @s container.14 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.12 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:14}
execute if items entity @s container.15 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.13 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:15}
execute if items entity @s container.16 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.14 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:16}
execute if items entity @s container.17 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.15 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:17}

execute if items entity @s container.20 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.18 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:20}
execute if items entity @s container.21 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.19 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:21}
execute if items entity @s container.22 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.20 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:22}
execute if items entity @s container.23 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.21 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:23}
execute if items entity @s container.24 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.22 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:24}
execute if items entity @s container.25 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.23 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:25}
execute if items entity @s container.26 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.24 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:26}

execute if items entity @s container.29 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.27 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:29}
execute if items entity @s container.30 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.28 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:30}
execute if items entity @s container.31 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.29 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:31}
execute if items entity @s container.32 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.30 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:32}
execute if items entity @s container.33 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.31 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:33}
execute if items entity @s container.34 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.32 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:34}
execute if items entity @s container.35 *[custom_data~{unt-1.blocks_diagonal_down_left:1b}] if items entity @s container.33 *[custom_data~{unt-1.blocks_diagonal:1b}] run return run function unt-1:inventory/return-item {slot:35}
