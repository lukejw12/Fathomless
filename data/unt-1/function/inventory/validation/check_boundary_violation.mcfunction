...
execute if score #target_slot unt-1.temp matches ..-1 run tag @s add unt-1.invalid_fish
execute if score #target_slot unt-1.temp matches ..-1 run return fail
execute unless score #target_slot unt-1.temp matches 0..35 run tag @s add unt-1.invalid_fish
...
execute if score #offset unt-1.temp matches 1 if score #col_diff unt-1.temp matches ..-1 run tag @s add unt-1.invalid_fish
execute if score #offset unt-1.temp matches -1 if score #col_diff unt-1.temp matches 1.. run tag @s add unt-1.invalid_fish

execute if score #offset unt-1.temp matches 9 unless score #col_diff unt-1.temp matches 0 run tag @s add unt-1.invalid_fish
execute if score #offset unt-1.temp matches -9 unless score #col_diff unt-1.temp matches 0 run tag @s add unt-1.invalid_fish

execute if score #offset unt-1.temp matches 8 if score #col_diff unt-1.temp matches 0.. run tag @s add unt-1.invalid_fish
execute if score #offset unt-1.temp matches 10 if score #col_diff unt-1.temp matches ..0 run tag @s add unt-1.invalid_fish
execute if score #offset unt-1.temp matches -8 if score #col_diff unt-1.temp matches ..0 run tag @s add unt-1.invalid_fish
execute if score #offset unt-1.temp matches -10 if score #col_diff unt-1.temp matches 0.. run tag @s add unt-1.invalid_fish