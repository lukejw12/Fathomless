...
{"function":"set_lore","lore":[{color:"white",italic:false,text:"Size:             "},{color:"$(color_type)",italic:false,text:$(feet_whole).$(feet_decimal)\""}],"mode":"append"},\
...
{"function":"set_components","components":{"minecraft:custom_data":{"unt-1.fish_value":$(fish_value_total),"unt-1.condition":"fresh"},"minecraft:tooltip_style":"unt-1:basic"}}\
]
