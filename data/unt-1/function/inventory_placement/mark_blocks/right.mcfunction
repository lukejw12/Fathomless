# Mark slot to the right (+1) as occupied
...
$execute if score #slot_$(slot) unt-1.slot_occupied matches 1 run scoreboard players add #blocked unt-1.slot_occupied 1
