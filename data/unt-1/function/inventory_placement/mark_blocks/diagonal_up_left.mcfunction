# Mark slot diagonal-up-left (-10) as occupied
...
$execute if score #slot_$(slot) unt-1.slot_occupied matches 1 run scoreboard players remove #blocked unt-1.slot_occupied 10
