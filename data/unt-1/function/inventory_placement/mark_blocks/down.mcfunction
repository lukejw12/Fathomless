...
execute if score #blocked unt-1.slot_occupied matches 35 run scoreboard players set #slot_35 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 36 run scoreboard players set #slot_36 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 37 run scoreboard players set #slot_37 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 38 run scoreboard players set #slot_38 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 39 run scoreboard players set #slot_39 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 40 run scoreboard players set #slot_40 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 41 run scoreboard players set #slot_41 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 42 run scoreboard players set #slot_42 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 43 run scoreboard players set #slot_43 unt-1.slot_occupied 1
execute if score #blocked unt-1.slot_occupied matches 44 run scoreboard players set #slot_44 unt-1.slot_occupied 1