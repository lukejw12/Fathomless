...
execute if score #check_diag unt-1.inv_slot matches 0 if score #slot_0 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
