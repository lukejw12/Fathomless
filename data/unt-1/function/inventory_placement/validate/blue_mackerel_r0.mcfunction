...
execute if score #check_right unt-1.inv_slot matches 28 if score #slot_28 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 29 if score #slot_29 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 30 if score #slot_30 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 31 if score #slot_31 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 32 if score #slot_32 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 33 if score #slot_33 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 34 if score #slot_34 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0
execute if score #check_right unt-1.inv_slot matches 35 if score #slot_35 unt-1.slot_occupied matches 1.. run scoreboard players set #valid unt-1.placement_success 0

execute if score #valid unt-1.placement_success matches 1 run function unt-1:inventory_placement/place/blue_mackerel_r0
