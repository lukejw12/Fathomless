scoreboard players operation #fish_value unt-1.temp = #blue_mackerel_base unt-1.const
...
scoreboard players operation #quality_percent unt-1.temp -= #blue_mackerel_min unt-1.const
scoreboard players operation #quality_percent unt-1.temp *= #100 unt-1.const
scoreboard players operation #quality_percent unt-1.temp /= #blue_mackerel_range unt-1.const
