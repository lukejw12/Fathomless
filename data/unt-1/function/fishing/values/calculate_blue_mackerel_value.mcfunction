...
scoreboard players operation #trophy_bonus unt-1.temp = #mackerel_max_length_100 unt-1.temp
...
scoreboard players operation #size_percent unt-1.temp /= #mackerel_max_length_100 unt-1.temp
